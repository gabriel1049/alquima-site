...
<section class="banner_home wrapper-padding">
  <div class="banner_container">
    ...
    <div class="banner_image">
      <img src="./img/banner-home-page.png" alt="Banner destaque Alquima">
    </div>
  </div>
...
<section class="section_diferenciais">
  <div class="container_diferenciais wrapper-padding">
    ...
    <div class="diferencial">
      <div class="icon_diferencial">
        <img src="https://cdn-icons-png.flaticon.com/512/1055/1055687.png" alt="Qualidade de Materiais" />
      </div>
    ...
    <div class="diferencial">
      <div class="icon_diferencial">
        <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Suporte técnico" />
      </div>
...
<section class="section_quem_somos wrapper-padding">
  ...
  <div class="item_dado">
    ...
    <!-- COLUNA IMAGEM -->
    <div class="quem_somos_imagem">
      <img src="./img/quem-somos-img.png" alt="Imagem da Alquima em alta definição">
    </div>
  </div>
</section>
...
<footer class="footer">
  <div class="footer_container wrapper-padding">
